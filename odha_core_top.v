...
module odha_core_top (
    ...
    // Hardgecodete normative Constraints (Spezifikation v0.2)
    ...
    // Asynchroner Invarianten-Prüfblock
    assign constraints_valid = ((T_STATIC_LOGIC + simulated_delay_ps) <= T_PATH_BUDGET) &&
                               (thermal_delta >= MIN_THERMAL_DELTA) &&
                               (erf_value >= MIN_ERF);

    // ASIC/FPGA-konformes Verhalten: Strukturierte Null-Evakuierung statt Tristate
